...
public class Jadwal {
	...
	public Jadwal(String sumber, int[][] conflictmatrix, int jumlahexam) {
		this.sumber = sumber;
	...
	public void printSchedule() {
    	...
    	System.out.println("\n================================================"); 
	    System.out.println("Jumlah timeslot yang dibutuhkan untuk menjadwalkan " + jumlahexam + " course di file " + sumber + " adalah "+ Arrays.stream(timeslot).max().getAsInt() + " timeslot.");
	}
}
